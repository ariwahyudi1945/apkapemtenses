				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="row" style="margin: 9px;">
							<div class="col-md-8">
								<input type="hidden" class="form-control" placeholder="Pencarian..." id="keyword">
							</div>
						...
						<div class="row" style="background-color: white; box-shadow: 0px 0px 5px 0px #adb6b5; margin: 20px; padding: 20px; border-radius: 10px;">
							<div class="col-md-12">
