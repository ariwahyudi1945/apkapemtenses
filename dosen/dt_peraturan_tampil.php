										...
										<div class="table-responsive">
											<table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
							                  ...
							                  <tbody>
							                    <?php 
								                    include '../koneksi.php';
								                    $tampil=mysqli_query($koneksi, "SELECT * FROM peraturan ORDER BY id_peraturan DESC") or die(mysqli_error());
								                    ...
								                    <tr>
								                        ...
								                        <td width="11%">
								                            <a href="#"><button class="btn btn-xs btn-info" title="Edit Data" data-toggle="modal" data-target="#myModaledit<?php echo $data['id_peraturan']; ?>">
