							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											<a href="dt_soal_tambah.php"><button class="btn btn-sm btn-primary"><i class="ace-icon fa fa-plus"></i> Tambah Data</button></a><br><br>
										</div>
										...
										<div class="table-responsive">
											<table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
							                  ...
							                  <tbody>
							                    <?php 
							                      include '../koneksi.php';
							                      $tampil=mysqli_query($koneksi, "SELECT * FROM soal, dosen WHERE soal.id_dosen=dosen.id_dosen ORDER BY nama_dosen DESC") or die(mysqli_error());
							                    ...
							                    <tr>
							                      ...
							                      <td width="11%">
						                            <a href="#"><button class="btn btn-xs btn-info" title="Edit Data" data-toggle="modal" data-target="#myModaledit<?php echo $data['id_soal']; ?>">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
													</button></a>

													<a href="dt_soal_hapus_proses.php<?php echo '?id_soal=' . $id_soal; ?>" onclick="javascript: return confirm('Are you sure you want to delete?')" target=""><button class="btn btn-xs btn-danger" title="Hapus Data">
														<i class="ace-icon fa fa-trash-o bigger-120"></i>
													</button></a>
						                          </td>
							                    </tr>

							                    <div class="modal fade" id="myModaledit<?php echo $data['id_soal']; ?>" tabindex="-1" role="dialog">
							                      <div class="modal-dialog" role="document">
							                          <div class="modal-content">
							                              <div class="modal-header">
							                                  <h4 class="modal-title" id="defaultModalLabel">Edit Data Soal</h4>
							                              </div>
							                              <div class="modal-body">
							                                  <form role="form" action="dt_soal_edit_proses.php" method="post" enctype="multipart/form-data">
							                                      <?php
							                                      $id_soal = $data['id_soal']; 
							                                      ...
							                                      <div class="form-group">
							                                          ...
							                                          <input type="text" value="<?= $row['id_soal'] ?>" name="id_soal" class="form-control" readonly>      
							                                      </div>

							                                      <div class="form-group">
							                                          <label class="bmd-label-floating">Soal</label>
							                                          <input type="text" value="<?= $row['soal'] ?>" name="soal" class="form-control" autocomplete="off" required>      
							                                      </div>

							                                      <div class="form-group">
							                                          <label class="bmd-label-floating">Kunci Jawaban</label>
							                                          <input type="text" value="<?= $row['knc_jwbn'] ?>" name="knc_jwbn" class="form-control" autocomplete="off" required>      
							                                      </div>
							                                      ...
							                                      <div class="form-group">
							                                          ...
							                                          <?php
							                                            //menu drop down
							                                            include('../koneksi.php');
							                                            $res = mysqli_query($koneksi, "SELECT * FROM soal, dosen WHERE soal.id_dosen=dosen.id_dosen AND id_soal='$id_soal'");
