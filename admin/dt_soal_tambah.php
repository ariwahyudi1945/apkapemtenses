						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form" action="dt_soal_tambah_proses.php" method="post" enctype="multipart/form-data">
											<input type="hidden" name="id_soal" id="form-field-1" placeholder="ID Soal" class="col-xs-10 col-sm-5" autocomplete="off" required />
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Soal </label>

												<div class="col-sm-9">
													<input type="text" name="soal" id="form-field-1" placeholder="Soal" class="col-xs-10 col-sm-5" autocomplete="off" required />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="knc_jwbn" id="form-field-1" placeholder="Kunci Jawaban" class="col-xs-10 col-sm-5" autocomplete="off" required />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pembuat Soal </label>

												<div class="col-sm-9">
													<?php
									                    //menu drop down
									                    include('../koneksi.php');
									                    $res = mysqli_query($koneksi, "SELECT * FROM soal, dosen WHERE soal.id_dosen=dosen.id_dosen ORDER BY nama_dosen DESC");
