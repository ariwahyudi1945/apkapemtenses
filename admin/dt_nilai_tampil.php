							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											<a href="dt_nilai_hapus_all_proses.php" onclick="javascript: return confirm('Are you sure you want to delete all?')"><button class="btn btn-sm btn-primary"><i class="ace-icon fa fa-trash-o"></i> Delete All</button></a><br><br>
										</div>
