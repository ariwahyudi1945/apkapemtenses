							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											<a href="dt_jurusan_tambah.php"><button class="btn btn-sm btn-primary"><i class="ace-icon fa fa-plus"></i> Tambah Data</button></a><br><br>
										</div>
										...
										<div class="table-responsive">
											<table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
							                  ...
							                  <tbody>
							                    <?php
								                    include '../koneksi.php';
								                    $tampil=mysqli_query($koneksi, "SELECT * FROM jurusan ORDER BY id_jur DESC") or die(mysqli_error());
								                    ...
								                    <tr>
								                        ...
								                        <td><?= $data['nama_jur']; ?></td>
								                        <td width="30%">
								                            <a href="#"><button class="btn btn-xs btn-info" title="Edit Data" data-toggle="modal" data-target="#myModaledit<?php echo $data['id_jur']; ?>">
															<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button></a>

															<a href="dt_jurusan_hapus_proses.php<?php echo '?id_jur=' . $id_jur; ?>" onclick="javascript: return confirm('Are you sure you want to delete?')" target=""><button class="btn btn-xs btn-danger" title="Hapus Data">
																<i class="ace-icon fa fa-trash-o bigger-120"></i>
															</button></a>
								                        </td>
								                    </tr>

								                    <div class="modal fade" id="myModaledit<?php echo $data['id_jur']; ?>" tabindex="-1" role="dialog">
								                      <div class="modal-dialog" role="document">
								                        <div class="modal-content">
								                          <div class="modal-header">
								                              <h4 class="modal-title" id="defaultModalLabel">Edit Data Jurusan</h4>
								                          </div>
								                          <div class="modal-body">
								                            <form role="form" action="dt_jurusan_edit_proses.php" method="post" enctype="multipart/form-data">
								                              <?php
								                              $id_jur = $data['id_jur']; 
								                              $query_edit = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE id_jur='$id_jur'");
								                              ...
								                              <div class="form-group">
								                                ...
								                                <input type="text" value="<?= $row['id_jur'] ?>" name="id_jur" class="form-control" readonly>      
								                              </div>

								                              <div class="form-group">
								                                <label class="bmd-label-floating">Nama Jurusan</label>
								                                <input type="text" value="<?= $row['nama_jur'] ?>" name="nama_jur" class="form-control" autocomplete="off" required>      
								                              </div>
