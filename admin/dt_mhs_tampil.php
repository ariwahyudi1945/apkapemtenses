							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											<a href="dt_mhs_tambah.php"><button class="btn btn-sm btn-primary"><i class="ace-icon fa fa-plus"></i> Tambah Data</button></a><br><br>
										</div>
										...
										<div class="table-responsive">
											<table id="tabel-data" class="table table-striped table-bordered table-responsive" width="100%" cellspacing="0">
							                  ...
							                  <tbody>
							                    <?php 
							                      include '../koneksi.php';
							                      $tampil=mysqli_query($koneksi, "SELECT * FROM mahasiswa, jurusan WHERE mahasiswa.id_jur=jurusan.id_jur ORDER BY id_mhs DESC") or die(mysqli_error());
							                    ...
							                    <tr>
							                      ...
							                      <td width="8%">
						                            <a href="#"><button class="btn btn-xs btn-info" title="Edit Data" data-toggle="modal" data-target="#myModaledit<?php echo $data['id_mhs']; ?>">
													<i class="ace-icon fa fa-pencil bigger-120"></i>
													</button></a>

													<a href="dt_mhs_hapus_proses.php<?php echo '?id_mhs=' . $id_mhs; ?>" onclick="javascript: return confirm('Are you sure you want to delete?')" target=""><button class="btn btn-xs btn-danger" title="Hapus Data">
														<i class="ace-icon fa fa-trash-o bigger-120"></i>
													</button></a>
						                          </td>
							                    </tr>

							                    <div class="modal fade" id="myModaledit<?php echo $data['id_mhs']; ?>" tabindex="-1" role="dialog">
							                        <div class="modal-dialog" role="document">
							                            <div class="modal-content">
							                                <div class="modal-header">
							                                    <h4 class="modal-title" id="defaultModalLabel">Edit Data Mahasiswa</h4>
							                                </div>
							                                <div class="modal-body">
							                                    <form role="form" action="dt_mhs_edit_proses.php" method="post" enctype="multipart/form-data">
							                                        <?php
							                                        $id_mhs = $data['id_mhs']; 
							                                        $query_edit = mysqli_query($koneksi, "SELECT * FROM mahasiswa, jurusan WHERE mahasiswa.id_jur=jurusan.id_jur AND id_mhs='$id_mhs' ORDER BY id_mhs DESC");
							                                        ...
							                                        <div class="form-group">
							                                            ...
							                                            <input type="text" value="<?= $row['id_mhs'] ?>" class="form-control" readonly>      
							                                        </div>

							                                        <div class="form-group">
							                                            <label class="bmd-label-floating">Nama</label>
							                                            <input type="text" value="<?= $row['nama_mhs'] ?>" name="nama" class="form-control" autocomplete="off" required>   
							                                        </div>
							                                        ...
							                                        <div class="form-group">
							                                            ...
							                                            <?php
							                                              ...
							                                              echo '<option value="'. $data2['id_jur'].'">'. $data2['nama_jur'] .'</option>';
