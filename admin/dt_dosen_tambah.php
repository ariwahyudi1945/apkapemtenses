						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form" action="dt_dosen_tambah_proses.php" method="post" enctype="multipart/form-data">
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> NIP </label>

												<div class="col-sm-9">
													<input type="text" name="id_dosen" id="form-field-1" placeholder="NIP" class="col-xs-10 col-sm-5" autocomplete="off" required />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="alamat" id="form-field-1" placeholder="Alamat" class="col-xs-10 col-sm-5" autocomplete="off" required />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<!-- <div class="col-sm-9">
													<div class="row">
														...
														<div class="col-sm-2">
															<input type="radio" name="agama" id="form-field-1" value="kristen" class="col-xs-10 col-sm-5" autocomplete="off" required />kristen
														</div>
														<div class="col-sm-2">
