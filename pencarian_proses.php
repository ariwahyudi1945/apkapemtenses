						...
						<div class="row">
							<div class="col-md-12">
								<?php
			                        include 'koneksi.php';
			                        $search = $_POST['search'];
					            	$query = mysqli_query($koneksi, "SELECT * FROM modul WHERE judul LIKE '%$search%'");
								...
								<div class="col-md-3">
									<div class="thumbnail search-thumbnail">
										...
										<div class="caption">
											...
											<button data-toggle="modal" class="btn btn-mini btn-success" data-target="#myModaledit<?php echo $data['id_modul']; ?>" title="<?= $data['judul']; ?>">View</button>
										</div>
									</div>
								</div>
